...
test("every direct UI phrase is included in the central English catalog", function()
    local EL = loadLocale("enUS")
    for _, filename in ipairs({ "Bootstrap.lua", "Renderer.lua", "Input.lua", "Interface.lua", "TrainingUI.lua", "TempestRenderer.lua", "TwinFangsUI.lua", "TwinFangsRenderer.lua", "SentinelsUI.lua", "SentinelsRenderer.lua" }) do
